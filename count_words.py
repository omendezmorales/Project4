...
for root, dirs, files in os.walk("."):
    for file in files:
        if file.endswith("report.ipynb") and not file.endswith("checkpoint.ipynb"):
            ...
            print('File {} has :'.format(file))
            print('\t -{} words in markdown text'.format(word_count_markdown))
            print('\t -{} words in heading text'.format(word_count_heading))
            print('\t -{} words in code text'.format(word_count_code))
